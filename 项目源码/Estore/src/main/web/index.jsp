...
<body style="background-color: #fafafa;">
	            ...
	            <div style="background-color: #fff;width: 234px;height:320px;float: left;margin-left: 11px; ">
	            	...
	            	<div style="width: 234px;height: 85px;">
	            		...
	            		<div style="width: 234px;height: 30px;line-height: 30px;text-align: center;color: #ff6700;font-size: 14px;font-family: Arial">
	            			 ${goods.price } <span style="color: #000;"> &nbsp;元 </span>
	            		</div>
	            		<div style="width: 234px;height: 35px;line-height: 35px;text-align: center;color: #000;font-size: 14px;font-family: Arial" title="${goods.description }">
	            			...
	            			<c:if test="${goods.description.length() > 12 }">
	            				${goods.description.substring(0, 12) }...
	            			</c:if>
	            		</div>
	            	</div>
	            </div>
                    	...
                    	<c:forEach items="${homeGoodes }" var="goods" varStatus="i">
                    		...
                    		<c:if test="${i.index > 3 }">
                    			<div class="appr_min" style="margin-left: 12px;width: 234px;height: 300px;background-color: #FFF;text-align: center;margin-top: 15px;" id="appr_min1">
		                  			<a href="<%=basePath %>index?func=findGoodsById&gid=${goods.gid }">
		                  				<img width="180px" height="180px;" src="<%=imgPath %>${goods.pic }" alt="">
		                  			</a>
		                  			<div style="width: 234px;height: 100px;">
		                  				<div style="width: 100%;height: 33px;text-align: center;font-size: 14px;font-family: Arial">${goods.gname }</div>
    ...
    <div class="capabackground">
        <div class="capacity">
            ...
            <div class="capa_box scrip_capa_box scrip_capa_box_on">
                <div class="capa_top">
                	<c:forEach items="${smartGoodes }" var="goods">
                		<!-- 智能家居 - 动态使用  -->
	                  	<div class="capa capa_shadow" style="width: 231px;height: 301px;text-align: center;background-color: #FFFFFF;margin-top: 15px;">
	                        <a href="<%=basePath %>index?func=findGoodsById&gid=${goods.gid }" target="_blank">
	                        	<img width="180px" height="180px" src="<%=imgPath %>${goods.pic }" />
	                            <div class="tran">
	                                <span>来自**的评价：差评~</span>
	                            </div>
	                        </a>
	                        <div class="capa_a">
	                            <ul>
	                                ...
	                                <li style="color: #b0b0b0" title="${goods.description }">
	                                	<c:if test="${goods.description.length() <= 12 }">
					            			${goods.description }
				            			</c:if>
				            			<c:if test="${goods.description.length() > 12 }">
    ...
    <div class="popular">
        <div class="popular_background">
            ...
            <div class="popu_box">
            	<!-- 动态数据使用，仅供参考 -->
            	<c:forEach items="${hotGoodes }" var="goods" varStatus="i">
            		<c:if test="${i.count == 1 }">
            			<div class="popu popu_unleft popu_shadow" >
	                        <a href="<%=basePath %>index?func=findGoodsById&gid=${goods.gid }" target="_blank">
	                        	<img style="width: 296px" height="220px" src="<%=imgPath %>${goods.pic }">
	                        </a>
	                        <div class="popu_bottom">
	                            <p class="review">
	                                	客服妹子真好看，来五方桥基地，请你吃屎丸子
	                            </p>
	                            <p class="author"> 来自于 ** 的评价 </p>
	                            <div class="info">
            		...
            		<c:if test="${i.count != 1 }">
            			<div class="popu popu_unleft popu_shadow" style="margin-left: 13px;">
	                        ...
	                        <div class="popu_bottom">
	                            <p class="review">
	                                	外形简洁大方，大爱小米！
	                                	全家人都在用小米的产品，真心不错，最主要的是性价比高。附图，给客服妹子一个大嘴巴子
	                            </p>
	                            <p class="author"> 来自于 ** 的评价 </p>
	                            <div class="info">
	                                <h3 class="title">${goods.gname }</h3>
